# -*- coding: utf-8 -*-
"""sentiment_analysis_deploy.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1kLW_ijGx8Ru5zVRYvXTILI4_JJkPy0_j
"""
...
loaded_model = load_model(os.path.join('/content/drive/MyDrive/Colab Notebooks/model_sentiment.h5'))

loaded_model.summary()

# to load tokenizer
TOKENIZER_PATH = os.path.join('/content/drive/MyDrive/Colab Notebooks/tokenizer_sentiment.json')
with open(TOKENIZER_PATH, 'r') as json_file:
    loaded_tokenizer = json.load(json_file)
    
# to load pickle
OHE_PICKLE_PATH = os.path.join('/content/drive/MyDrive/Colab Notebooks/ohe_sentiment.pkl')
